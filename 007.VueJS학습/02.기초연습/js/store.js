...
export default new Vuex.Store({
  ...
  state: {
    ...
    cityData: {
      ...
      "광주": {
        이미지: `https://i.namu.wiki/i/rbJatPhz5PS2KYkbEKOiJFDXUqdXhPgo8omVHp27WF2iKcyK4_7EDft5N0q-rsTsc87OJQyAQdIiM1wBpksreI2tI6mtm9Qi-xE1zxzj6s6Fmwe9wgQ583Lb4_eQqPbKQkSIlrrYijuf3u0_Ij76Pw.webp`,
        설명: `과거 광주읍 일대는 광주천과 무등산에서 흘러나온 수많은 소하천들로 인해 늪지가 많았다. 지금은 사라진 광주의 고 유적인 경양방죽 또한 광주읍성 외곽의 수많은 늪지대들의 물을 빼기 위한 관개시설이었다. 따라서 물이 많은 들판 이라 해 '물들'이라는 지명으로 불리게 되었고, 발음상 편의를 위해 물들에서 '무들', '무등' 등으로 변해 불리웠다. 이어, 전국 지명의 한자화 정책에 의해 '물들'은 '무(無)주(州)' 가 되었고, 이 무주에 보배 진(珍)을 넣어 무진주, 무진 등의 이름으로 불리게 되었다. 똑같이 무등산은 물들의 뒷산이라 하여 무들산, 무등산이 되었다는 설이 있다.`,
      },
      "부산": {
  ...
  // 2. 데이터변경 메서드 구역 - 컴포넌트에서 호출시, commit() 사용
  mutations: {
    // 초기데이터 셋업 메서드
    initSet(헐, 파람) {
      //  전달변수는 두번째 변수 '파람'임
  ...
  // 3. 비동기처리 메서드 구역 - 컴포넌트에서 호출시, dispatch() 사용
  actions: {
    myAct(헝, 벙) {
