...
export function Board() {
  ...
  useEffect(() => {
    ...
    // 만약 글쓰기(C)모드에서 로그아웃을 한 경우 리스트 페이지 이동
  ...
  const chgMode = (e) => {
    ...
    // 3-4. 글쓰기 서브밋 /////////
      ...
      // 2. 통과시 실제 데이터 입력하기
        ...
        // 스프레드 연산자 나오기 전에는 항상 apply메서드 사용한다.
        // apply(this객체,배열값) -> this객체 전달없으므로 null쓴다.
        // -> 배열값 내부의 값을 하나씩 전달함
          ...
          <>
            ...
            <div className="selbx">
              <select name="cta" id="cta" className="cta">
                ...
                <option value="unm">Whiter</option>
              </select>
              <select name="sel" id="sel" className="sel">
                <option value="0">JeongRyeol</option>
                <option value="1">Ascending</option>
                <option value="2">Descending</option>
              </select>
              <input id="stxt" type="text" length="50" />
