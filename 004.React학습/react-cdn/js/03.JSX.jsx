...
// (2) JSX를 사용하지 않는 방법
// -> 넣을 요소를 createElement() 메서드로 생성해야한다. (JSX를 안쓴다.)
const myEle2 = React.createElement("h1",{},"나는 JSX를 쓰지않아!")
// createWElement(요소명,{JS코드작성},요소내용)
...
// 출력형식
// <li>배우명 : 영화명 </li>
// 배열변수 .map() 을 사용해보자! -> 여기서도 맵쬬잉! 인가??
// -> JS map()과는 다른 별도의 출력처리가 이루어진다.
// 결론: map() 만 사용하여 바로 출력가능하다.
