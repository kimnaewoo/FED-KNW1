...
// 해결방안 : useMemo()!!!
  ...
  // 현재증상: nara는 isKor에 연결되었으나 score에는 연결되어 있지않음! 그런데 왜? nara에 
  // 변경을 관리하는 useEffect에 걸리는 걸까???
  React.useEffect(()=>{
    console.log('nara가 변경됨!!!');
    // 축구선수 이미지 중 해당나라 이미지가 위로 올라옴
    $('img').eq(isKor?1:0) // isKor이 1이면 '손흥민' 0이면 '미토마'
  ...
  /* 
    ...
    -> 방지의 원리는 의존성을 심어서 실제로 변경되는 데이터를 특정하여 정확한 반영을 위해 기존데이터를 재사용해준다!
  */
  ...
  return (
    <header className="header" style={{ textAlign: "center" }}>
      <h1>
        한국과 일본이 축구를 하고 있습니다!
        <br />
        {isKor ? "한국이" : "일본이"} 몇점 차로 승리를 예측하십니까?
      </h1>
      <input
        type="number"
        value={score}
      ...
      {/* 다나카 */}
      <img
        src="https://i.namu.wiki/i/LqJxOgNUWQjcKzlLxu5RtMl5cp4CPIj52bJS24dfj4mkDeD1VtFTTy5I-CDk2w9JZjdPnlgTRHHTdUPjdmi2I-tDQuEJzdHXRFyEOQd87N-NHikfpLfa2ksbFzUkb1Wp7-onFp4-Z7IIY6vugQcWQw.webp"
        style={{
          height: "300px",
          position: "fixed",
          bottom: "-100px",
      ...
      {/* 손흥민 */}
      <img
        src="https://i.namu.wiki/i/CXjjT0z0jiJP1ntw9UYxG6R3DHYT8a5fRmcHx2oi9voXZUY5D8Lbr5xi6zxaLi6YmsSKy1fnKoIjWSizThvUWnQakrhVBMZOIQ_16Dlu2sSLVuPCDWAKANiTE2sq46c4g9xUg_G1sECSvTC4JYlSJg.webp"
        style={{
          height: "300px",
          position: "fixed",
          bottom: "-100px",
