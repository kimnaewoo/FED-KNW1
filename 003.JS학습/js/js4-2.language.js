...
/********************************************************************************************************** 
        원래 제이슨파일 과 같은 데이터 파일을 불러올때는 데이터 파일을 다 불러온 후, 
        그 데이터를 이용하는 코드가 실행되도록 하는 비동기코딩방식인 Promise를 사용하는 것이 원칙이다!
 **********************************************************************************************************/

console.log(langCode);

// 1. 다국어 요구사항
// - 언어선택박스를 변경하면 해당코드에 맞게 다국어 데이터를 제이슨파일에서 읽어, 본 페이지에 데이터를 변경한다.

// 2. 대상선정
// 2-1. 이벤트대상 : .sel
const selBox = dFn.qs('.sel');

// 2-2. 변경대상 : #gnb a / #id img / #info address 
// (1) GNB메뉴 : gnb a
