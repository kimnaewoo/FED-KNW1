...
/****************************************************************************************************************************************************************** 
    ...
    -> 주의: 숫자를 비교해도 문자열로 비교하기 때문에 "25"와 "100" 중 큰숫자는 100이지만 25를 더 큰 데이터로 인식한다. -> sort() 메서드 비교함수로 처리!
...
// console.log('숫자배열sort((x,y)=>x-y):',arrNumber.sort((x,y)=>x-y));
...
function sortingFn(){
    ...
    if(optVal==1){
        list1.sort((a,b)=>{
            // a,b 는 모두 객체 데이터. 따라서, 내부 속성을 구체적으로 비교해야함
